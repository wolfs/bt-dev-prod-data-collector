...
public class Tags extends TableImpl<TagsRecord> {
    ...
    private static final long serialVersionUID = -1994175974;
    ...
    public List<ForeignKey<TagsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<TagsRecord, ?>>asList(Keys.TAGS__TAGS_TIME_TO_FIRST_TASK_FK);
    }

    public TimeToFirstTask timeToFirstTask() {
        return new TimeToFirstTask(this, Keys.TAGS__TAGS_TIME_TO_FIRST_TASK_FK);
    }
